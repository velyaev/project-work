...
будем считать, что если мы сможем немного разгрузить учебный офис от ответов на простые вопросы, то проект можно считать успешным.
...
### 3.1 Сбор и предобработка данных
	• Будет фиксорованный пулл страниц и пдф для программ ФКН 
	...
	сайт военного учебного центра чуток отличается от сайта вышки, поэтому его будте сложно превести к единому виду,
